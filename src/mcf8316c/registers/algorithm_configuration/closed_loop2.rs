...
impl From<ClosedLoop2> for u32 {
    fn from(config: ClosedLoop2) -> Self {
        let mut value = 0;
        value |= (config.mtr_stop as u32) << 28;
        value |= (config.mtr_stop_brk_time as u32) << 24;
        value |= (config.act_spin_thr as u32) << 20;
        value |= (config.brake_speed_threshold as u32) << 16;
        value |= (config.motor_res as u32) << 8;
        value |= config.motor_ind as u32;
        value
    }
}

impl From<u32> for ClosedLoop2 {
    fn from(value: u32) -> Self {
        // Safety: The values are masked to their respective bit widths, so they are guaranteed to be valid.
        unsafe {
            ClosedLoop2 {
                mtr_stop: MotorStop::from(((value >> 28) & 0xF) as u8),
                mtr_stop_brk_time: MotorStopBrakeTime::try_from(((value >> 24) & 0xF) as u8).unwrap_unchecked(),
                act_spin_thr: PercentDecreasing::try_from(((value >> 20) & 0xF) as u8).unwrap_unchecked(),
                brake_speed_threshold: PercentDecreasing::try_from(((value >> 16) & 0xF) as u8).unwrap_unchecked(),
                motor_res: MotorResistance::from(((value >> 8) & 0xFF) as u8),
                motor_ind: MotorInductance::from((value & 0xFF) as u8),
            }
        }
    }
}
...
impl From<u8> for MotorStop {
    fn from(value: u8) -> Self {
        match value {
            0x0 => MotorStop::HiZ,
            0x2 => MotorStop::LowSideBraking,
            0x3 => MotorStop::HighSideBraking,
            0x4 => MotorStop::ActiveSpinDown,
            0x5 => MotorStop::AlignBraking,
            _ => panic!("Invalid value for MotorStop: {}", value),
        }
    }
}
...
impl TryFrom<u8> for MotorStopBrakeTime {
    type Error = BitCountError;

    fn try_from(value: u8) -> Result<Self, Self::Error> {
        match value {
            0x0 => Ok(MotorStopBrakeTime::Ms1_1),
            0x1 => Ok(MotorStopBrakeTime::Ms1_2),
            0x2 => Ok(MotorStopBrakeTime::Ms1_3),
            0x3 => Ok(MotorStopBrakeTime::Ms1_4),
            0x4 => Ok(MotorStopBrakeTime::Ms1_5),
            0x5 => Ok(MotorStopBrakeTime::Ms5),
            0x6 => Ok(MotorStopBrakeTime::Ms10),
            0x7 => Ok(MotorStopBrakeTime::Ms50),
            0x8 => Ok(MotorStopBrakeTime::Ms100),
            0x9 => Ok(MotorStopBrakeTime::Ms250),
            0xA => Ok(MotorStopBrakeTime::Ms500),
            0xB => Ok(MotorStopBrakeTime::Ms1000),
            0xC => Ok(MotorStopBrakeTime::Ms2500),
            0xD => Ok(MotorStopBrakeTime::Ms5000),
            0xE => Ok(MotorStopBrakeTime::Ms10000),
            0xF => Ok(MotorStopBrakeTime::Ms15000),
...
impl TryFrom<u8> for PercentDecreasing {
    type Error = BitCountError;

    fn try_from(value: u8) -> Result<Self, Self::Error> {
        match value {
            0x0 => Ok(PercentDecreasing::P100),
            0x1 => Ok(PercentDecreasing::P90),
            0x2 => Ok(PercentDecreasing::P80),
            0x3 => Ok(PercentDecreasing::P70),
            0x4 => Ok(PercentDecreasing::P60),
            0x5 => Ok(PercentDecreasing::P50),
            0x6 => Ok(PercentDecreasing::P45),
            0x7 => Ok(PercentDecreasing::P40),
            0x8 => Ok(PercentDecreasing::P35),
            0x9 => Ok(PercentDecreasing::P30),
            0xA => Ok(PercentDecreasing::P25),
            0xB => Ok(PercentDecreasing::P20),
            0xC => Ok(PercentDecreasing::P15),
            0xD => Ok(PercentDecreasing::P10),
            0xE => Ok(PercentDecreasing::P5),
            0xF => Ok(PercentDecreasing::P2_5),
            _ => Err(BitCountError::new(4, value.ilog2() as u8)),
        }
    }
}
